...
public class Type_O extends Player
{
...
void Init_Data(){
	...
	long seed = (ID + 92) * gameNumber + (ID + 112);
...
DirectionCode GetMovableAdjacentDirection()
{
	...
	for ( iDirection = 0; iDirection < 4; iDirection++ )
	{
		...
		if ( adjacentPoint.row >= 0 &&
				adjacentPoint.row < Constants.Classroom_Height && adjacentPoint.column >= 0 && adjacentPoint.column < Constants.Classroom_Width )
			break;
	}
