 ...
 * 이 플레이어는 에어쇼의 우측 날개를 담당합니다.
 * 
 * @author Racin
 *
 */
public class Player_성동에어쇼3 extends Player
{
	DirectionCode dir;
	...
	{
		if ( info_sunDoo == null || 
				info_sunDoo.state == StateCode.Corpse && info_sunDoo.transition_cooldown != 0 )
		{
			// 아직 선두가 안 나왔거나 나오자마자 죽어 있거나 아직 한 칸을 이동하지 않았다면 유예
			int variableToMakeError = 0;
