 ...
 *
 */
public class Byun extends Player
{
	...
	{
		if (sangtae==0 && myScore.survivor_max>60)
		{
			sangtae=1;
		}
		switch (sangtae)
	...
	private DirectionCode Move_1() //Scout play
	{
		/*
		...
		for ( int iWeights = 0; iWeights < 4; iWeights++ )
		{
			...
			case Up:
				...
				break;
			case Left:
				// 왼쪽: 1459				weights[iWeights] = numberOfPlayers[1] + numberOfPlayers[4] + numberOfPlayers[5] + numberOfPlayers[9];
				break;
			case Right:
				// 오른쪽: 378B
	...
	private DirectionCode Move_0() //생존자 play
	{
		/*
	...
	private Point Soul_Spawn_2() //CorpseBomb play
	{
		int max_weight = 0;
		int max_row = -1;
		int max_column = -1;
	...
	private Point Soul_Spawn_1() //Scout play
	{
		int max_weight = 0;
		int max_row = -1;
		int max_column = -1;
	...
	private Point Soul_Spawn_0() //시작 : 정중앙	
	{
