...
public class Fittest extends Player {
	...
	public DirectionCode Survivor_Move() {
		 ...
		 *              ..를 합산하여 비교합니다.
		 */
		if(this.turnInfo.turnNumber <58)
		{
	...
	public DirectionCode Infected_Move() {
		//////////////////////////3x3내에 시체가 없다면 정화기도하는 코드 추가
		if (this.myInfo.HP > 77) {
	...
	public Point Soul_Spawn() {
		...
		} else if(this.turnInfo.turnNumber == 0){
