 ...
 *
 */
public class 공주 extends Player
{
   ...
   {
     if (myScore.corpse_max < 13 && myScore.survivor_max  < 80) {
      // 내 밑에 시체가 깔려 있으면 도망감
   ...
   {
      if (myScore.survivor_max > 15 || turnInfo.turnNumber > 50) {
         int max_weight = 0;
         int max_row = -1;
         int max_column = -1;
