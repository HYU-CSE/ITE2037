 ...
 * 
 */
public class Player_JiWon extends Player
{/**
	...
	public Player_JiWon()
	{
		name = "다중이";	// TODO 자신이 만들 플레이어의 이름으로 name 필드를 초기화하세요.
		acceptDirectInfection = false;				// TODO '직접 감염'을 받으려는 경우 이 필드를 true로 두고 아닌 경우 false로 두세요.
		
		this.receiveOthersInfo_detected = true;		//정찰병은 생존자 이동에서 다른 플레이어가 가장 적은 방향으로 이동하기 위해 포착 정보를 수신함
